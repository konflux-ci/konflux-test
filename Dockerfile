...
FROM registry.access.redhat.com/ubi9/go-toolset:9.5-1744294473 as check-payload-build
...
FROM docker.io/snyk/snyk:linux@sha256:e61b9860d842f12e07fe0d7ca71484be40adf2d38b22cd9d1c56e7b1e74ae186 as snyk
