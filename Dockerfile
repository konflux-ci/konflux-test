...
FROM registry.access.redhat.com/ubi9/go-toolset:9.6-1751375493 as check-payload-build

WORKDIR /opt/app-root/src

ARG CHECK_PAYLOAD_VERSION=0.3.8
...
FROM docker.io/snyk/snyk:linux@sha256:d9e063dd23922ccca11b57aced3dc6384dbd18fe79434aa7bf2c872b8a7b0b38 as snyk
FROM quay.io/conforma/cli:snapshot@sha256:af3cb05815598c3ac9357755a15a802a350821db0bc14cccdc1a6ebbc883ceb0 AS conforma
