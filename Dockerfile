...
FROM registry.access.redhat.com/ubi9/go-toolset:9.6-1749052980 as check-payload-build
...
FROM quay.io/enterprise-contract/ec-cli:snapshot@sha256:f6faddea11326a4fd65d82ac840bf55f61a5e51fb9907e7de7e67028dbb24ef7 AS ec-cli
