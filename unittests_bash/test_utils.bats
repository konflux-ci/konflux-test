...
@test "Get matching catalog image from fragment: registry/fbc-fragment@valid-success" {
    run get_matching_fbc_catalog_image -i registry/fbc-fragment@valid-success -b registry.redhat.io/openshift4/ose-operator-registry
...
@test "Get matching catalog image from fragment: registry/fbc-fragment@valid-success default index" {
    run get_matching_fbc_catalog_image -i registry/fbc-fragment@valid-success
